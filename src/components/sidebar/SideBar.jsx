...
const Sidebar = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-white pt-9 flex flex-col relative duration-300 shadow-xl shadow-[#E2ECF9] ${
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <img className="" src="/assets/company_logo.svg" alt="" />
        {isOpen && (
      ...
      <nav className="flex-1 mt-16">
        <ul className="space-y-5">
          ...
          <li>
            <a
              href="#"
              className="flex items-center text-white py-3 px-2 bg-[#6060c0] rounded-lg"
            >
              <img
